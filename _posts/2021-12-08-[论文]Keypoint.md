...
$$\Pi_C(S_i;\theta) = \Phi_C(r_i;\theta) = P_i \tag$$
...
$$P_i = \Phi_C(r_i;\theta) = R_i mat(B_C c_i) \tag$$
...
$$P_{i\frac{1}{2}} = R_i mat(B_{C\frac{1}{2}}c_i), P_i = \left[P_{i\frac{1}{2}}, A_C P_{i\frac{1}{2}} \right] \tag$$
...
$$P_i = R_i \left[mat(B_{C\frac{1}{2}} c_i), mat(B_{C\frac{1}{2}}^{'} c_i^{'}) \right] \tag$$
