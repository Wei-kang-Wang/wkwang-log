...
文章在标准的benchmarks上测试了我们的unsupervised 3D keypoints的semantic consistency，并在unsupervised方法中获得了sota的结果。文章同时也展现了找到的keypoints对于shape deformation来说非常的合适。最后，其提供了用户交互时操作shape control的实例，并且在project主页上包含了交互式shape control的视频。
...
### [精读Unsupervised Learning of Category-Specific Symmetric 3D Keypoints from Point Sets](https://www.ecva.net/papers/eccv_2020/papers_ECCV/papers/123700545.pdf)
