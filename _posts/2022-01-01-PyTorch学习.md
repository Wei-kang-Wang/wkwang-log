...
* $$H_{out} = \lceil \frac{H_{in} + 2 \times padding \left[0 \right] - dilation \left[0 \right] \times (kernel_size \left[0 \right] - 1) - 1}{stride \left[0 \right]} + 1 \rceil$$
* $$W_{out} = \lceil \frac{W_{in} + 2 \times padding \left[0 \right] - dilation \left[0 \right] \times (kernel_size \left[0 \right] - 1) - 1}{stride \left[0 \right]} + 1 \rceil$$
