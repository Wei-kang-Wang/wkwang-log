...
## 1.2 Python的metaclass

https://segmentfault.com/a/1190000007255412

## 1.3 decorator和descripter
...
### 1.6 python -c 命令与python -m 命令的用法
...
#### 2.2.1 os.mkdir()和os.makedirs()函数
