...
2. Numpy的官方文档：https://numpy.org/doc/stable/index.html
包括了基本的user guide（大致介绍了基本用法）、API（完整的内容介绍）、developer guide（给想开发的人的指南）。
3. Pandas库的官方文档：https://pandas.pydata.org/docs/
包括了基本的user guide（大致介绍了基本用法）、API（完整的内容介绍）、developer guide（给想开发的人的指南）。
4. Matplotlib库的官方文档：https://matplotlib.org/stable/index.html
5. Scikit-learn库的官方文档：https://scikit-learn.org/stable/index.html
