...
### \[**CVPR 2023**\] [Learning Steerable Function for Efficient Image Resampling](https://lerf.pages.dev/)

### \[**ECCV 2024**\] [NamedCurves: Learned Image Enhancement via Color Naming](https://namedcurves.github.io/)

### [UniReal: Universal Image Generation and Editing via Learning Real-world Dynamics](https://xavierchen34.github.io/UniReal-Page/)

### [VideoAnydoor : High-fidelity Video Object Insertion with Precise Motion Control](https://videoanydoor.github.io/)

### [Edicho: Consistent Image Editing in the Wild](https://github.com/ant-research/edicho?tab=readme-ov-file)
...
### \[**Arxiv 2024**\] [MangaNinja: Line Art Colorization with Precise Reference Following](https://johanan528.github.io/MangaNinjia/)
...
### [Lite2Relight: 3D-aware Single Image Portrait Relighting](https://reality.tf.fau.de/publications/2024/rao2024light2relight/rao2024light2relight.html)

### [Noise Calibration: Plug-and-play Content-Preserving Video Enhancement using Pre-trained Video Diffusion Models](https://yangqy1110.github.io/NC-SDEdit/)


## 图片/视频去噪、去雾、去模糊

### \[**ACM SIGGRAPH 2024**\] [Deep Hybrid Camera Deblurring for Smartphone Cameras](https://cg.postech.ac.kr/research/HCDeblur/)
...
### [AnyDressing : Customizable Multi-Garment Virtual Dressing via Latent Diffusion Models](https://crayon-shinchan.github.io/AnyDressing/)
...
### \[**CVPR 2024**\] [Towards High-Quality 3D Motion Transfer with Realistic Apparel Animation](https://github.com/rongakowang/MMDMC)

## Animation

### \[**ECCV 2024**\] [3DEgo: 3D Editing on the Go!](https://3dego.github.io/)

### \[**ECCV 2024**\] [DreamMotion: Space-Time Self-Similar Score Distillation for Zero-Shot Video Editing](https://hyeonho99.github.io/dreammotion/)

### \[**ECCV 2024**\] [Animate Your Motion: Turning Still Images into Dynamic Videos](https://mingxiao-li.github.io/smcd/)

### \[**Arxiv 2024**\] [OCD: Object-Centric Diffusion for Efficient Video Editing](https://qualcomm-ai-research.github.io/object-centric-diffusion/)
...
### \[**Arxiv 2024**\] [FlipSketch: Flipping Static Drawings to Text-Guided Sketch Animations](https://github.com/hmrishavbandy/FlipSketch)

### \[**Arxiv 2024**\] [AniDoc: Animation Creation Made Easier](https://yihao-meng.github.io/AniDoc_demo/)

### \[**Arxiv 2024**\] [Textualize Visual Prompt for Image Editing via Diffusion Bridge](https://pengchengpcx.github.io/TextVDB/)
