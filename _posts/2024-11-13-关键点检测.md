...
![hourglass0]({{ '/assets/images/HOURGLASS-0.PNG' | relative_url }}){: width=800px style="float:center"} 
...
![hourglass1]({{ '/assets/images/HOURGLASS-1.PNG' | relative_url }}){: width=800px style="float:center"} 
*Fig 1. 一个hourglass模块的介绍。图中每个box都是fig 2里的一个residual模块。*


![hourglass2]({{ '/assets/images/HOURGLASS-2.PNG' | relative_url }}){: width=800px style="float:center"} 
