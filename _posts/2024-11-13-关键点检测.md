...
$$v = (x_{j_2, k} - x_{j_1, l}) / \lvert x_{j_2, k} - x_{j_1, l} \rvert$$是从$$x_{j_1, k}$$指向$$x_{j_2, k}$$的单位向量，$$v_{\bot}$$是垂直于$$v$$的一个单位向量，而对于任意的像素点$$p$$，如果其满足$$ 0 \leq v (p - x_{j_1,k}) \leq \lVert x_{j_2, k} - x_{j_1, k} \rVert$$ 和 $$\lvert v_{\perp} (p - x_{j_1,k}) \rvert \leq \sigma_l$$，
